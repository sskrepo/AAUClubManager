...
## Right now, your top 2

From the active phase ([PHASE-0.md](PHASE-0.md)):

1. **360dialog account** — long-pole external dependency (Meta verification 1–7 days). **Start ASAP.**
2. **Resend account + verified domain** — needed for email delivery test

Everything else is mid-phase or non-blocking. See [PHASE-0.md](PHASE-0.md) for the full list and how-to instructions.
